"! This class is used to fill travel data into the table zrap100_atrav600
CLASS zcl_rap100_gen_data_600 DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_600 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '600',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav600.
*    DELETE FROM zrap100_dtrav600.

    "insert travel demo data
    INSERT zrap100_atrav600  FROM (
        SELECT
